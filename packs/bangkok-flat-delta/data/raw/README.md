...
The river, canal, coastline, and study-extent coordinates are selected from the cited OpenStreetMap inputs (Chao Phraya River Relation 227317, Gulf of Thailand coastline ways, and Khlong Saen Saep waterway), rather than redrawn. The elevation context polygon was derived from SRTM/Copernicus digital elevation models (elevation ≤ 5 m above mean sea level). The recurrent water and flood extent polygon was derived from JRC Global Surface Water and delta wetland retention areas. Neither the elevation zone nor the flood extent represents a surveyed or event-specific flood boundary.
